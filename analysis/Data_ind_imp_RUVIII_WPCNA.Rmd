...
```{r GO enrichment 2, fig.width = 10, fig.height = 15}
hubs <- get_hubs_gcn(WGCNA_DF, net)
ontology_categories <- c("ALL")
...
```{r GO enrichment 3, fig.width = 10, fig.height = 15}
hubs <- get_hubs_gcn(WGCNA_DF, net)
ontology_categories <- c("ALL")
...
# mapped to SNPs ini specific kinds of loci. 
pQTL_data$Target.UniProt
